...
and capabilities. Mirrored from mycosoft_mas.devices.capability_manifest for use by
the standalone MycoBrain service (which may run without MAS package). Keep in sync.
