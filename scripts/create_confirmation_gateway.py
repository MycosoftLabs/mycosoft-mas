"""Helper script to create confirmation_gateway.py"""
import os
...
with open('mycosoft_mas/voice/confirmation_gateway.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('Created confirmation_gateway.py')
