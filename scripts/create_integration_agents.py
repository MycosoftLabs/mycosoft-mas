#!/usr/bin/env python3
"""
Create MAS v2 Integration Agents

Creates agents for external service integrations:
...
'''
    ...
    (agents_dir / "integration_agents.py").write_text(content)
    print("Created mycosoft_mas/agents/v2/integration_agents.py")


def update_v2_init_with_integrations():
    """Update __init__.py to include integration agents"""
    content = '''"""
MAS v2 Agents
...
'''
    ...
    print("Updated mycosoft_mas/agents/v2/__init__.py with integration agents")


def main():
    """Create integration agents"""
    print("Creating MAS v2 Integration Agents...")
    print(f"Base directory: {BASE_DIR}")
    print()
    
    create_integration_agents()
    update_v2_init_with_integrations()
    
    print()
    print("All integration agents created successfully!")
