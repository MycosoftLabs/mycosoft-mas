"""Helper script to create aws_integration.py"""
import os
...
os.makedirs('mycosoft_mas/integrations', exist_ok=True)
with open('mycosoft_mas/integrations/aws_integration.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('Created aws_integration.py')
