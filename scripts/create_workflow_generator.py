"""Helper script to create workflow_generator_agent.py"""
import os
...
with open('mycosoft_mas/agents/workflow_generator_agent.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('Created workflow_generator_agent.py')
