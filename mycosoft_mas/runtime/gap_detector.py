...
class GapDetector:
    ...
    REQUIRED_AGENTS = {
        ...
        AgentCategory.INFRASTRUCTURE: [
            ...
            },
            {
                ...
                "agent_type": "network-manager",
                "description": "Network management",
            },
            {
                "agent_id": "storage-agent",
                "agent_type": "storage-manager",
        ...
        AgentCategory.DEVICE: [
            {
                ...
                "description": "MycoBrain fleet management",
            },
        ],
        ...
        AgentCategory.DATA: [
            {
                ...
                "agent_type": "database",
                "description": "MINDEX database operations",
            },
    ...
    async def _scan_category_gaps(self):
        ...
        for category, required_agents in self.REQUIRED_AGENTS.items():
            ...
            existing_ids = {
                a.agent_id for a in existing if a.status in [AgentStatus.ACTIVE, AgentStatus.BUSY]
            }
            ...
            for agent_spec in required_agents:
                if agent_spec["agent_id"] not in existing_ids:
                    gap = AgentGap(
                        ...
                        severity=(
                            "high"
                            if category in [AgentCategory.CORE, AgentCategory.SECURITY]
                            else "medium"
                        ),
                        suggested_agent={
