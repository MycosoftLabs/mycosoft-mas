            ...
            try:
                async with session.get(
                    ...
                    if response.status == 200:
                        ...
                        logger.warning("PubChem rate limited, backing off...")
            ...
            try:
                async with session.get(
                    ...
                    if response.status == 200:
                        ...
                        logger.warning("ChEMBL rate limited, backing off...")
    ...
    async def fetch_fungal_compounds(
        ...
        try:
            ...
            for name in compound_names:
                ...
                # Also search ChEMBL
                chembl_ids = await self.search_chembl(
                    name, limit=limit_per_compound, session=session
                )
