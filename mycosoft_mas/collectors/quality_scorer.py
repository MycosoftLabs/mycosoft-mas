...
def calculate_recency_score(timestamp: datetime, max_age_hours: float = 24.0) -> float:
    """
...
def calculate_completeness_score(data: Dict[str, Any], entity_type: str) -> float:
    """
...
def calculate_precision_score(
    lat: Optional[float], lng: Optional[float], entity_type: str
) -> float:
    """
...
def calculate_quality_score(
    data: Dict[str, Any], entity_type: str, source: str, timestamp: Optional[datetime] = None
) -> float:
    """
    ...
    factors = QualityFactors(
        ...
        precision=calculate_precision_score(data.get("lat"), data.get("lng"), entity_type),
