...
class MetricsCollector:
            ...
            try:
                ...
                if self.last_metrics["performance"]:
                    last_time = datetime.fromisoformat(
                        self.last_metrics["performance"]["timestamp"]
                    ).timestamp()
                ...
                await self.websocket_server.update_performance_metrics(
                    time.time() - current_time, throughput
                )
    ...
    def update_agent_status(
        ...
        asyncio.create_task(self.websocket_server.update_agent_status(agent_id, status, details))
