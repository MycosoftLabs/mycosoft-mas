...
class SecurityCodeReviewer:
    ...
    async def review_code_change(self, change_request: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        approved = len(issues) == 0 or all(
            issue.get("severity") in ["warning", "info"] for issue in issues
        )
    ...
    def _validate_change_type(self, change_type: str, requester_id: str) -> List[Dict[str, Any]]:
    ...
    async def scan_for_vulnerabilities(self, file_paths: List[str]) -> List[Dict[str, Any]]:
        """
