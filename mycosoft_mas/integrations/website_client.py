...
class WebsiteClient:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.api_url = self.config.get(
            "api_url", os.getenv("WEBSITE_API_URL", "https://mycosoft.vercel.app/api")
        ).rstrip("/")

        # Authentication
        self.api_key = self.config.get("api_key", os.getenv("WEBSITE_API_KEY", ""))
    ...
    async def submit_contact_form(
        self, name: str, email: str, message: str, subject: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        """
        health = {"timestamp": datetime.utcnow().isoformat(), "status": "unknown"}
