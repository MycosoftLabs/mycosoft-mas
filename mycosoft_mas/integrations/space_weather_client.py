...
class SpaceWeatherClient:
    ...
    async def get_neo_browse(self) -> Dict[str, Any]:
        ...
        client = await self._get_client()
        response = await client.get(
            f"{self.nasa_neo_url}/neo/browse", params={"api_key": self.nasa_api_key}
        )
        response.raise_for_status()
        return response.json()
    ...
    async def get_kp_index(self) -> List[List[Any]]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/products/noaa-planetary-k-index.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_space_weather_alerts(self) -> List[Dict[str, Any]]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/products/alerts.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_aurora_forecast(self) -> Dict[str, Any]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/json/ovation_aurora_latest.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_xray_flux(self) -> List[List[Any]]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/json/goes/primary/xrays-7-day.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_ace_mag(self, period: str = "1h") -> List[List[Any]]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/products/ace/mag_{period}.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_dscovr_plasma(self) -> List[List[Any]]:
        ...
        client = await self._get_client()
        response = await client.get(f"{self.noaa_swpc_url}/products/dscovr/plasma-1-day.json")
        response.raise_for_status()
        return response.json()
    ...
    async def get_weather_forecast(self, lat: float, lon: float) -> Dict[str, Any]:
        ...
        response = await client.get(f"{self.noaa_weather_url}/points/{lat},{lon}", headers=headers)
        response.raise_for_status()
    ...
    async def get_weather_alerts(
        self, state: Optional[str] = None, active: bool = True
    ) -> Dict[str, Any]:
        """Get weather alerts."""
        client = await self._get_client()
        headers = {"User-Agent": "MycoSoft-MAS/1.0"}
