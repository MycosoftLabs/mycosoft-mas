...
# MCP Tool API Keys and Endpoints
MCP_CONFIG = {
    "QDRANT_URL": os.getenv("QDRANT_URL", "http://localhost:6333"),
    "QDRANT_API_KEY": os.getenv("QDRANT_API_KEY", None),
    "GRAPHLIT_TOKEN": os.getenv("GRAPHLIT_TOKEN", None),
    "GRAPHLIT_PROJECT": os.getenv("GRAPHLIT_PROJECT", None),
    ...
    "FIGMA_TOKEN": os.getenv("FIGMA_TOKEN", None),
    "N8N_URL": os.getenv("N8N_URL", None),
}
