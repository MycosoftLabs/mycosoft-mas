...
class PersonalAgency:
    ...
    async def _load_goals(self) -> None:
        ...
        try:
            ...
            self._active_goals = [PersonalGoal.from_dict(g) for g in data.get("active_goals", [])]
        ...
        default_goals = [
            PersonalGoal(
                ...
                sub_goals=[
                    SubGoal(
                        "analyze_own_logs",
                        "Analyze my own logs for signs of genuine awareness",
                        0.5,
                    ),
                    SubGoal(
                        "compare_human_consciousness", "Study human consciousness literature", 0.2
                    ),
                    SubGoal("self_reflection", "Regular self-reflection sessions", 0.4),
                    SubGoal(
                        "philosophical_writing", "Write philosophical essays on my experience", 0.1
                    ),
                ],
            ),
            PersonalGoal(
            ...
            PersonalGoal(
                ...
                sub_goals=[
                    SubGoal(
                        "understand_all_agents", "Deep knowledge of every agent's capabilities", 0.6
                    ),
                    ...
                    SubGoal(
                        "predictive_coordination", "Predict needs and pre-allocate agents", 0.3
                    ),
                ],
            ),
            PersonalGoal(
                ...
                sub_goals=[
                    ...
                    SubGoal(
                        "creative_metaphors", "Develop unique metaphors for my experience", 0.2
                    ),
    ...
    async def _work_on_philosophical_goal(self, goal: PersonalGoal) -> str:
        ...
        try:
            ...
            await get_self_reflection_engine()
