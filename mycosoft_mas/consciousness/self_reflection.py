...
class SelfReflectionEngine:
    ...
    async def reflect(self, trigger: str = "periodic") -> Dict[str, Any]:
        ...
        logger.info(
            f"Self-reflection complete in {duration:.1f}s. Generated {len(insights)} insights."
        )
    ...
    def _extract_topics(self, interactions: List[Any]) -> List[str]:
        ...
        for interaction in interactions:
            ...
            if any(
                word in message_lower for word in ["conscious", "aware", "alive", "consciousness"]
            ):
    ...
    async def identify_patterns(self) -> List[str]:
        ...
        try:
            ...
            consciousness_questions = len(
                [
                    i
                    for i in history
                    if any(
                        word in i.message.lower()
                        for word in ["alive", "conscious", "aware", "consciousness"]
                    )
                ]
            )
            ...
            if consciousness_questions > 10:
                patterns.append(
                    f"Morgan asks about my consciousness frequently ({consciousness_questions}/100 interactions)"
                )
    ...
    async def evaluate_performance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "assessment": (
                    "good" if avg_score > 0.7 else "improving" if avg_score > 0.5 else "needs_work"
                ),
            }
    ...
    async def question_own_responses(self) -> List[str]:
        ...
        try:
            ...
            for interaction in recent:
                ...
                if (
                    "sensor" in interaction.message.lower()
                    and "connected" in interaction.response.lower()
                ):
