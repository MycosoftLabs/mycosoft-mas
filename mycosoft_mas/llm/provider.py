...
class LLMError(Exception):
    ...
    def __init__(
        self, message: str, provider: str, model: str, original_error: Optional[Exception] = None
    ):
...
class LLMProvider(ABC):
    ...
    def _handle_error(self, error: Exception, model: str, operation: str) -> LLMError:
        ...
        return LLMError(
            message=message, provider=self.provider_name, model=model, original_error=error
        )
