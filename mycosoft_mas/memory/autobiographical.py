...
class AutobiographicalMemory:
    ...
    async def get_user_history(self, user_id: str, limit: int = 100) -> List[Interaction]:
    ...
    async def get_milestone_moments(self, user_id: Optional[str] = None) -> List[Interaction]:
        ...
        try:
            ...
            response = await self._client.get(
                f"{self.mindex_url}/api/memory/autobiographical", params=params
            )
            response.raise_for_status()
            data = response.json()
    ...
    async def get_relationship_evolution(self, user_id: str) -> Dict[str, Any]:
        """
    ...
    async def search_memories(
        ...
        try:
            ...
            response = await self._client.get(
                f"{self.mindex_url}/api/memory/autobiographical/search", params=params
            )
            response.raise_for_status()
            data = response.json()
    ...
    async def get_context_for_response(
        self, user_id: str, current_message: str, context_window: int = 10
    ) -> Dict[str, Any]:
        """
