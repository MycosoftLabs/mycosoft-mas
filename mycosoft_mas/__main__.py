"""
Mycosoft MAS Main Entry Point

This module serves as the package entry point for running the Mycosoft Multi-Agent System.
When the package is run with python -m mycosoft_mas, this module will be executed.
"""
