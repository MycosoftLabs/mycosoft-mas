...
class ClimateConnector(BaseConnector):
    ...
    async def search(
        ...
        if any(d in relevant for d in [EarthSearchDomain.MODIS, EarthSearchDomain.LANDSAT, EarthSearchDomain.AIRS]):
    ...
    async def _search_noaa_buoys(self, geo: Optional[GeoFilter], limit: int) -> List[EarthSearchResult]:
