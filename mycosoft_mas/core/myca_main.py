...
from mycosoft_mas.agents.security.auth_service import router as auth_router, auth_service
...
class MycosoftMAS:
    ...
    def _setup_routes(self) -> None:
        ...
        # Include routers
        self.app.include_router(agents, dependencies=[Depends(auth_service.verify_token)])
        self.app.include_router(tasks, dependencies=[Depends(auth_service.verify_token)])
        self.app.include_router(dashboard, dependencies=[Depends(auth_service.verify_token)])
