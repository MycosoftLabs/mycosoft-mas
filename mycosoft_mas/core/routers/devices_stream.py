...
class DeviceStreamManager:
    ...
    async def connect(self, websocket: WebSocket, device_id: str):
        ...
        logger.info(
            f"Device stream: Client connected to {device_id}. Total for device: {len(self.device_connections[device_id])}"
        )
    ...
    async def disconnect(self, websocket: WebSocket, device_id: str):
        ...
        logger.info(
            f"Device stream: Client disconnected from {device_id}. Total: {len(self.all_connections)}"
        )
