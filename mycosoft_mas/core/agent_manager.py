...
class AgentManager:
    ...
    async def get_agent_status(self) -> Dict[str, Any]:
        ...
        return {
            agent_id: {
                ...
                "last_heartbeat": self.agent_metrics.get(agent_id, {}).get(
    ...
    async def get_agent_metrics(self) -> Dict[str, Any]:
        ...
        return {
            agent_id: {
                ...
                "messages_processed": self.agent_metrics.get(agent_id, {}).get(
    ...
    async def get_active_agents(self) -> List[str]:
        ...
        return [agent_id for agent_id, status in self.agent_status.items() if status == "running"]
