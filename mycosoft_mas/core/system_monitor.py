...
class SystemMonitor:
    ...
    async def _load_from_registry(self) -> None:
        ...
        try:
            ...
            pool = await asyncpg.create_pool(self._database_url, min_size=1, max_size=2)
    ...
    async def check_health(self, component_id: str) -> Optional[HealthCheck]:
        ...
        check = HealthCheck(component_id=component_id, component_type=component.component_type)
            ...
            if component.url and component.health_endpoint:
                ...
                try:
                    reader, writer = await asyncio.wait_for(
                        asyncio.open_connection(component.host, component.port), timeout=5.0
                    )
                    writer.close()
