...
class IncubatorAgent(BaseScientificAgent):
    ...
    def __init__(self):
        super().__init__(
            "incubator_agent",
            "Incubator Agent",
            "Controls temperature, humidity, and CO2 for growth chambers",
        )
...
class PipettorAgent(BaseScientificAgent):
    ...
    def __init__(self):
        super().__init__(
            "pipettor_agent", "Pipettor Agent", "Controls robotic liquid handling systems"
        )
...
class BioreactorAgent(BaseScientificAgent):
    ...
    def __init__(self):
        super().__init__(
            "bioreactor_agent",
            "Bioreactor Agent",
            "Controls bioreactors for cultivation and fermentation",
        )
...
class MicroscopyAgent(BaseScientificAgent):
    ...
    def __init__(self):
        super().__init__(
            "microscopy_agent", "Microscopy Agent", "Controls microscopes for imaging and analysis"
        )
    ...
    async def _z_stack(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "slices": z_range_um // step_size_um,
        }
