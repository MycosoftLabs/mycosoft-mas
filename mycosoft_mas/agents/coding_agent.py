...
class CodingAgent:
    ...
    async def fix_bug(
        self, description: str, target_files: Optional[List[str]] = None
    ) -> CodingTask:
        """
    ...
    async def _analyze_bug(
        self, description: str, target_files: Optional[List[str]]
    ) -> Dict[str, Any]:
...
"""
    ...
    async def create_pull_request(
        ...
        try:
            ...
            if self.voice_announcer:
                self.voice_announcer("Pull request created successfully.")
    ...
    def _create_pr_via_gh(
        self, title: str, description: str, branch: str, base: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "base": base,
                "title": title,
                "status": "branch pushed, PR creation needs manual step",
            }
...
"""
    ...
    async def create_agent_via_claude(self, agent_description: str) -> Dict[str, Any]:
    ...
    async def create_endpoint_via_claude(self, endpoint_description: str) -> Dict[str, Any]:
    ...
    async def deploy_via_claude(self, target_vm: str = "mas") -> Dict[str, Any]:
    ...
    async def _execute_with_safety(
        ...
        result = await self.invoke_claude_code(checkpoint_prompt, target_repo=target_repo)
