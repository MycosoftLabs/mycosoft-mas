...
from mycosoft_mas.agents.messaging.message import Message, MessagePriority, MessageType
...
class DesktopAutomationAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str, name: str, config: dict):
        ...
        if pyautogui:
            ...
            self.logger.warning("pyautogui not available; desktop automation features disabled")
            ...
            if browser_type == "chrome":
                ...
                await self.send_message(
                    Message(
                        ...
                        data={"action": "browser_started", "profile_name": profile_name},
                    )
                )
            else:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "navigation_complete", "url": url},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "login_complete", "status": "success"},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "form_filled", "status": "success"},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "data_extracted", "data": extracted_data},
                )
            )
        except Exception as e:
    ...
    async def _handle_solve_captcha(self, message: Message) -> None:
        ...
        try:
            profile_name = message.data.get("profile_name", "default")
            message.data.get("captcha_type", "image")
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "captcha_solved", "status": "success"},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.BROWSER,
                    priority=MessagePriority.NORMAL,
                    data={"action": "browser_closed", "profile_name": profile_name},
                )
            )
        except Exception as e:
    ...
    async def _handle_start_application(self, message: Message) -> None:
        ...
        try:
            ...
            Application().start(f"{app_path} {' '.join(app_args)}")

            await self.send_message(
                Message(
                    type=MessageType.DESKTOP,
                    priority=MessagePriority.NORMAL,
                    data={"action": "application_started", "app_path": app_path},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.DESKTOP,
                    priority=MessagePriority.NORMAL,
                    data={"action": "element_clicked", "x": x, "y": y},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.DESKTOP,
                    priority=MessagePriority.NORMAL,
                    data={"action": "text_typed", "text": text},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.DESKTOP,
                    priority=MessagePriority.NORMAL,
                    data={"action": "window_data_extracted", "data": window_data},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.DESKTOP,
                    priority=MessagePriority.NORMAL,
                    data={"action": "application_closed", "window_title": window_title},
                )
            )
        except Exception as e:
