...
class StripeClient:
    ...
    async def cancel_subscription(
        self, subscription_id: str, cancellation_data: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def pay_invoice(
        self, invoice_id: str, payment_data: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        Pay an invoice.
    ...
    async def list_events(
        self, event_types: Optional[List[str]] = None, limit: int = 100
    ) -> List[Dict[str, Any]]:
        """
        List recent events.
