"""
Speech Agent - Speech coordination.
...
class SpeechAgent(BaseAgent if BaseAgent is not object else object):  # type: ignore[misc]
    """Speech coordination."""
    ...
    def __init__(self, agent_id: str, name: str, config: Dict[str, Any]):
        ...
        self.capabilities = ["speech", "audio", "voice"]
    ...
    async def run_cycle(self) -> Dict[str, Any]:
        return {
            ...
            "knowledge_added": 0,
            "summary": "SpeechAgent idle cycle complete",
        }
