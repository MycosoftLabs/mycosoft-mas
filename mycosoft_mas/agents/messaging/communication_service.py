...
class CommunicationService:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.metrics = {
            ...
            "error_counts": {"validation": 0, "email": 0, "sms": 0, "voice": 0},
        }
    ...
    async def send_notification(self, notification: Dict[str, Any]) -> bool:
        """Send a notification."""
        try:
            self.notifications.append({**notification, "timestamp": datetime.now().isoformat()})
    ...
    async def send_sms(self, to_number: str, message: str, sender_id: Optional[str] = None) -> bool:
        """
        Send an SMS.
        ...
        try:
            ...
            try:
                ...
                message_obj = client.messages.create(body=message, from_=twilio_from, to=to_number)
    ...
    async def send_voice_notification(
        self, to_number: str, message: str, language: str = "en-US", voice: str = "en-US-Wavenet-D"
    ) -> bool:
        """
        ...
        try:
            ...
            try:
                ...
                client = Client(twilio_sid, twilio_token)
                call = client.calls.create(twiml=str(response), to=to_number, from_=twilio_from)
