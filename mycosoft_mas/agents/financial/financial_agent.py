...
from mycosoft_mas.agents.messaging.message_types import Message, MessagePriority, MessageType
...
class FinancialAgent(BaseAgent):
    ...
    def __init__(self, agent_id: str, name: str, config: dict):
        ...
        self.stripe_client = StripeClient(api_key=config["stripe_api_key"])
        ...
        try:
            ...
            await self.send_message(
                Message(
                    ...
                    data={"action": "balance_response", "balances": balances},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.FINANCIAL,
                    priority=MessagePriority.NORMAL,
                    data={"action": "transactions_response", "transactions": transactions},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.FINANCIAL,
                    priority=MessagePriority.NORMAL,
                    data={"action": "statement_response", "statement": statement},
                )
            )
        except Exception as e:
    ...
    async def _handle_process_payment(self, message: Message) -> None:
        ...
        try:
            ...
            confirmed_intent = await self.stripe_client.confirm_payment_intent(payment_intent["id"])
            ...
            await self.send_message(
                Message(
                    ...
                    priority=MessagePriority.NORMAL,
                    data={"action": "payment_processed", "payment_intent": confirmed_intent},
                )
            )
        except Exception as e:
    ...
    async def _handle_create_payment_method(self, message: Message) -> None:
        ...
        try:
            ...
            payment_method = await self.stripe_client.create_payment_method(payment_method_data)
            ...
            await self.send_message(
                Message(
                    type=MessageType.PAYMENT,
                    priority=MessagePriority.NORMAL,
                    data={"action": "payment_method_created", "payment_method": attached_method},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.PAYMENT,
                    priority=MessagePriority.NORMAL,
                    data={"action": "payment_history_response", "payments": payments},
                )
            )
        except Exception as e:
    ...
    async def _handle_create_subscription(self, message: Message) -> None:
        ...
        try:
            ...
            subscription = await self.stripe_client.create_subscription(subscription_data)
            ...
            await self.send_message(
                Message(
                    ...
                    priority=MessagePriority.NORMAL,
                    data={"action": "subscription_created", "subscription": subscription},
                )
            )
        except Exception as e:
        ...
        try:
            ...
            await self.send_message(
                Message(
                    type=MessageType.SUBSCRIPTION,
                    priority=MessagePriority.NORMAL,
                    data={"action": "subscription_updated", "subscription": subscription},
                )
            )
        except Exception as e:
    ...
    async def _handle_cancel_subscription(self, message: Message) -> None:
        ...
        try:
            ...
            subscription = await self.stripe_client.cancel_subscription(
                subscription_id, cancellation_data
            )
            ...
            await self.send_message(
                Message(
                    type=MessageType.SUBSCRIPTION,
                    priority=MessagePriority.NORMAL,
                    data={"action": "subscription_cancelled", "subscription": subscription},
                )
            )
        except Exception as e:
