...
class DatabaseAgent(BaseAgent if BaseAgent is not object else object):  # type: ignore[misc]
    """Database operations."""
    ...
    def __init__(self, agent_id: str, name: str, config: Dict[str, Any]):
        ...
        self.capabilities = ["database", "query", "migrate"]
    ...
    async def run_cycle(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "knowledge_added": 0,
            "summary": "DatabaseAgent idle cycle complete",
        }
