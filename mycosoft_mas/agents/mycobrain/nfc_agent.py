...
class NFCAgent(BaseAgent if BaseAgent is not object else object):  # type: ignore[misc]
    """NFC tag operations."""
    ...
    def __init__(self, agent_id: str, name: str, config: Dict[str, Any]):
        ...
        self.capabilities = ["nfc", "tag", "read", "write"]
    ...
    async def process_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if task_type == "read":
            return {"status": "success", "result": {"data": None}}
    ...
    async def run_cycle(self) -> Dict[str, Any]:
        return {
            ...
            "knowledge_added": 0,
            "summary": "NFCAgent idle cycle complete",
        }
