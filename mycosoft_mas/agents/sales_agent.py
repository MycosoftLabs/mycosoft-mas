...
class SalesAgent(BaseAgent):
    ...
    async def _handle_sales_update(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "message": "Sales data updated successfully"}
        except Exception as e:
            logger.error(f"Error handling sales update: {str(e)}")
            return {"status": "error", "message": f"Failed to update sales data: {str(e)}"}
    ...
    async def _handle_customer_query(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "error", "message": f"Failed to process customer query: {str(e)}"}
