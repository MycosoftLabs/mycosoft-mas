...
class DialogAgent(BaseAgent if BaseAgent is not object else object):  # type: ignore[misc]
    """Dialog management."""
    ...
    def __init__(self, agent_id: str, name: str, config: Dict[str, Any]):
        ...
        self.capabilities = ["dialog", "conversation", "context"]
    ...
    async def run_cycle(self) -> Dict[str, Any]:
        return {
            ...
            "knowledge_added": 0,
            "summary": "DialogAgent idle cycle complete",
        }
