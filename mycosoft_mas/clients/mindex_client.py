...
class MINDEXClient(BaseClient):
    ...
    async def search_species(
        ...
        """
        params = {"q": query, "limit": limit, **(filters or {})}
    ...
    async def log_growth_data(self, species_id: str, data: Dict[str, Any]) -> ClientResponse:
        """
        ...
        """
        return await self.post(f"/api/v1/species/{species_id}/growth", json_data=data)

    async def get_research_papers(
        self, species_id: Optional[str] = None, topic: Optional[str] = None, limit: int = 10
    ) -> ClientResponse:
        """
