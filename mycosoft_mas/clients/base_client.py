...
class BaseClient:
    ...
    async def _request(
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                return ClientResponse(
                    success=False, error=str(e), response_time_ms=(time.time() - start_time) * 1000
                )
    ...
    async def post(
        ...
        """Make a POST request."""
        return await self._request(
            "POST", endpoint, json_data=json_data, headers=headers, response_model=response_model
        )
    ...
    async def put(
        ...
        """Make a PUT request."""
        return await self._request(
            "PUT", endpoint, json_data=json_data, headers=headers, response_model=response_model
        )
    ...
    async def delete(
        ...
        return await self._request(
            "DELETE", endpoint, headers=headers, response_model=response_model
        )
