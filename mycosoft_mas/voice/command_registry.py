...
class VoiceCommandRegistry:
    ...
    def _load_default_commands(self):
        defaults = [
            ...
            RegisteredCommand(
                command_id="natureos.earth_forecast",
                name="Earth-2 Forecast",
                description="Run Earth-2 weather forecast",
                patterns=[
                    r"(?:run|start)\s+earth\s*2\s+forecast",
                    r"earth\s*2\s+forecast",
                    r"earth\s+forecast",
                ],
                command_type=CommandType.QUERY,
                handler=CommandHandler("natureos", "natureos-matlab", "/api/voice/tools/execute", "POST"),
            ...
            RegisteredCommand(
                command_id="natureos.simulate_petri",
                name="Petri Dish Simulation",
                description="Run Petri dish growth simulation",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.simulate_mushroom",
                name="Mushroom Simulation",
                description="Run mushroom growth simulation",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.simulate_compound",
                name="Compound Simulation",
                description="Run compound reaction simulation",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.simulate_genetic_circuit",
                name="Genetic Circuit Simulation",
                description="Run genetic circuit simulation",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.simulate_lifecycle",
            ...
            RegisteredCommand(
                command_id="natureos.simulate_physics",
            ...
            RegisteredCommand(
                command_id="natureos.growth_analytics",
                name="Growth Analytics",
                description="Run growth analytics",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.retrosynthesis",
                name="Retrosynthesis",
                description="Run retrosynthesis analysis",
                patterns=[
                    r"retrosynthesis",
            ...
            RegisteredCommand(
                command_id="natureos.alchemy_lab",
                name="Alchemy Lab",
                description="Run alchemy lab analysis",
                patterns=[
                    r"alchemy\s+lab",
                    r"run\s+alchemy",
                ],
            ...
            RegisteredCommand(
                command_id="natureos.sync_twin",
                name="Digital Twin Sync",
                description="Sync a digital twin device state",
                patterns=[
            ...
            RegisteredCommand(
                command_id="natureos.symbiosis_network",
                name="Symbiosis Network Analysis",
                description="Analyze symbiosis network for a location",
                patterns=[
            ...
            RegisteredCommand(
                ...
                name="Spore Tracking",
                description="Track spores for a location and time range",
                patterns=[
                    r"track\s+spores",
                    r"spore\s+tracking",
                    r"spore\s+dispersal",
