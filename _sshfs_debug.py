...
sshpass -p 'Mushroom1!Mushroom1!' ssh -o StrictHostKeyChecking=no mycosoft@192.168.0.187 "ls /mnt/mycosoft-nas/" 2>&1

echo ""
echo "=== Mounting with SSHFS ==="
sshpass -p 'Mushroom1!Mushroom1!' sshfs -o StrictHostKeyChecking=no,reconnect,ServerAliveInterval=15 mycosoft@192.168.0.187:/mnt/mycosoft-nas /mnt/nas-share
echo "Exit: $?"
