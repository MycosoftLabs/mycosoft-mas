...
class TestEarth2Models:
    ...
    def test_spatial_extent_validation(self):
        ...
        # Valid extent
        extent = SpatialExtent(min_lat=30.0, max_lat=50.0, min_lon=-100.0, max_lon=-80.0)
        assert extent.min_lat == 30.0
        assert extent.max_lat == 50.0

        # Invalid latitude should raise error
        with pytest.raises(ValueError):
            SpatialExtent(min_lat=-100.0, max_lat=50.0, min_lon=-100.0, max_lon=-80.0)  # Invalid
    ...
    def test_forecast_params_creation(self):
        ...
        from mycosoft_mas.earth2.models import (
            Earth2Model,
            ForecastParams,
            TimeRange,
            WeatherVariable,
    ...
    def test_nowcast_params_creation(self):
        ...
        from mycosoft_mas.earth2.models import Earth2Model, NowcastParams, SpatialExtent
...
class TestEarth2Service:
    ...
    async def test_run_forecast_simulated(self, service):
        ...
        from mycosoft_mas.earth2.models import Earth2Model, ForecastParams, WeatherVariable
    ...
    async def test_run_nowcast_simulated(self, service):
        ...
        from mycosoft_mas.earth2.models import Earth2Model, NowcastParams, WeatherVariable
...
class TestEarth2Tools:
    ...
    async def test_execute_earth2_forecast(self):
        ...
        result = await execute_earth2_forecast(
            {"location": "Chicago, IL", "latitude": 41.88, "longitude": -87.63, "forecast_days": 3}
        )
    ...
    async def test_execute_earth2_nowcast(self):
        ...
        result = await execute_earth2_nowcast(
            {"latitude": 39.0, "longitude": -98.0, "forecast_hours": 3}
        )
