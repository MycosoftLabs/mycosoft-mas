# MYCA Export — Skill: Neuromorphic Integration

**Export Date:** MAR16_2026  
**Skill Name:** neuromorphic-integration  
**Purpose:** Integrate neuromorphic UI into a page. Use when converting Shadcn pages to neuromorphic design or adding neuromorphic styling.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests neuromorphic UI.
