# MYCA Export — Skill: Setup Env Vars

**Export Date:** MAR16_2026  
**Skill Name:** setup-env-vars  
**Purpose:** Configure .env.local with correct VM URLs and API keys for the Mycosoft website. Use when setting up the dev environment, fixing API connection issues, or after VM changes.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user sets up Mycosoft development.
