# MYCA Export — Skill: Create Integration Client

**Export Date:** MAR16_2026  
**Skill Name:** create-integration-client  
**Purpose:** Create a new integration client module for the MAS system. Use when adding a new external service integration, API client, or third-party connector.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new external service integrations.
