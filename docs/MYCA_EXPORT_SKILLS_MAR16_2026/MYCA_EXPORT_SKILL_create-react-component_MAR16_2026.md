# MYCA Export — Skill: Create React Component

**Export Date:** MAR16_2026  
**Skill Name:** create-react-component  
**Purpose:** Create a React component following Mycosoft patterns with Shadcn UI, Radix, and Tailwind CSS. Use when building new UI components, widgets, or interactive elements.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new UI components.
