# MYCA Export — Skill: Create API Route

**Export Date:** MAR16_2026  
**Skill Name:** create-api-route  
**Purpose:** Create a new Next.js API route for the Mycosoft website. Use when adding backend API endpoints, proxy routes to MAS/MINDEX, or webhook handlers.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new website API routes.
