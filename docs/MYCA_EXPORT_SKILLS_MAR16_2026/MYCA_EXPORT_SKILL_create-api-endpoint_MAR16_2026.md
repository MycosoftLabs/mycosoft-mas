# MYCA Export — Skill: Create API Endpoint

**Export Date:** MAR16_2026  
**Skill Name:** create-api-endpoint  
**Purpose:** Create a new FastAPI router and endpoints for the MAS system. Use when adding new API endpoints, creating new routers, or extending the MAS API surface.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new MAS API endpoints.
