# MYCA Export — Skill: Start Dev Website

**Export Date:** MAR16_2026  
**Skill Name:** start-dev-website  
**Purpose:** Start the Mycosoft website dev server on port 3010. Use when the user wants to run the dev server, start development, or test the website locally.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user wants to run the website dev server.

---

## CRITICAL: Execute Yourself

**NEVER ask the user to run these commands.** Execute them yourself via terminal. See `agent-must-execute-operations.mdc`.
