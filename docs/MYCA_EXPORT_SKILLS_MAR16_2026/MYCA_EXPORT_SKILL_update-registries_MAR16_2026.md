# MYCA Export — Skill: Update Registries

**Export Date:** MAR16_2026  
**Skill Name:** update-registries  
**Purpose:** Update Mycosoft system registries after code changes. Use after adding agents, API endpoints, services, devices, or documentation.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user adds Mycosoft components.
