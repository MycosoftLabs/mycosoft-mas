# MYCA Export — Skill: VM Health Check

**Export Date:** MAR16_2026  
**Skill Name:** vm-health-check  
**Purpose:** Check health of all Mycosoft VMs (Sandbox, MAS, MINDEX). Use when verifying system status, debugging connectivity, or after deployments.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user asks about system health.
