# MYCA Export — Skill: Create MAS Agent

**Export Date:** MAR16_2026  
**Skill Name:** create-mas-agent  
**Purpose:** Create a new MAS agent following the BaseAgent pattern. Use when adding a new agent to the Multi-Agent System, creating a specialized agent, or extending agent capabilities.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new MAS agents.
