# MYCA Export — Skill: Database Migration

**Export Date:** MAR16_2026  
**Skill Name:** database-migration  
**Purpose:** Create and apply database migrations for the MINDEX PostgreSQL database. Use when modifying database schema, adding tables, or changing columns.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests database schema changes.
