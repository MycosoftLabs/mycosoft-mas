# MYCA Export — Skill: Create Next.js Page

**Export Date:** MAR16_2026  
**Skill Name:** create-nextjs-page  
**Purpose:** Create a new Next.js App Router page for the Mycosoft website. Use when adding a new page, route, or section to the website.  
**External Systems:** Base44, Claude, Perplexity, OpenAI, Grok — load when user requests new website pages.
