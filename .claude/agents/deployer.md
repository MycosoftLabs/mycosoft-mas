...
```bash
ssh mycosoft@192.168.0.189 "cd /opt/mycosoft/mas && docker compose stop mindex-api && docker compose rm -f mindex-api && docker compose build --no-cache mindex-api && docker compose up -d mindex-api"
```
